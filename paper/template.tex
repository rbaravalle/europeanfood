...
$\vcenter{\hbox{\includegraphics[scale = 0.35]{../images/fitbox}}}$
...
%The goal of this work is to show the impact of the features, rather than that of the classifier. 
%The Nearest Neighbor results are considered the most relevant among the three classifiers, since it presents the simplest classification rules.
